...
export default function Home() {
  return (
    <div>
      {/* Hero Section */}
      <section className="relative text-center h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-100 via-purple-50 to-pink-100 -mt-20 pt-10">
        ...
        <section className="flex items-center justify-center py-20 h-[90vh]">
          <div className='w-pc'>
            ...
            <div className="flex items-center justify-center">
              ...
              <svg width="80" height="40" viewBox="0 0 80 40" className="mx-2">
                <path
                  d="M 0 20 Q 40 10, 80 20"
                  stroke="#93c5fd"
                  strokeWidth="2"
                  fill="none"
                />
...
<div className='flex flex-col'>
  <p className='text-[88px] bg-gradient-to-r from-blue-400 to-blue-200 bg-clip-text text-transparent'>Accuracy</p>
  <p className='text-[22px]'>최대 98.6% AI 예측 정확도</p>
</div>
<div className='flex flex-col'>
  <p className='text-[88px] bg-gradient-to-r from-blue-500 to-blue-300 bg-clip-text text-transparent'>Scalability</p>
  <p className='text-[22px]'>다양한 산업에 적용 가능한 224개의 예측 모델 보유</p>
</div>
<div className='flex flex-col'>
  <p className='text-[88px] bg-gradient-to-r from-blue-400 to-blue-200 bg-clip-text text-transparent'>Expertise</p>
